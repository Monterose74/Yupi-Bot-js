...
module.exports.run = async(client, message, args) => {
  const createbot = client.createdAt
  ...
  .setFooter(`Yupi ${createbot}`, 'https://cdn.discordapp.com/avatars/871668247055982602/0a69ce8b042acb6511ec1df12d12a4a1.webp?size=4096');
